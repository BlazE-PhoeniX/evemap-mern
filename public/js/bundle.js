...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\"><strong>").concat(msg, "</strong></div>");
...
exports.closeModal = exports.openModalToAdd = exports.openModal = void 0;
...
var idInput = document.querySelector("#event-id");
var latInput = document.querySelector("#event-lat");
var lngInput = document.querySelector("#event-lng");
var nameInput = document.querySelector("#event-name");
var dateInput = document.querySelector("#event-date");
var timeInput = document.querySelector("#event-time");
var descInput = document.querySelector("#event-desc");
var addrInput = document.querySelector("#event-addr");
var editBtn = document.querySelector(".model__btn--edit");
var saveBtn = document.querySelector(".model__btn--save");
var deleteBtn = document.querySelector(".model__btn--delete");
var mapsLink = document.querySelector(".maps-link");

var defillInputs = function defillInputs() {
...
var addReadOnly = function addReadOnly() {
...
var removeReadOnly = function removeReadOnly() {
...
var prefixZero = function prefixZero(number) {
  return number < 10 ? "0".concat(number) : "".concat(number);
};

var hideButtons = function hideButtons(save, edit, maps) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            eventId = _args.length > 0 && _args[0] !== undefined ? _args[0] : "";
            editMode = _args.length > 1 && _args[1] !== undefined ? _args[1] : true;
            coords = _args.length > 2 ? _args[2] : undefined;
            defillInputs(idInput, latInput, lngInput, nameInput, dateInput, timeInput, descInput, addrInput);
            mapsLink.href = "#";

            if (editMode) {
              removeReadOnly(idInput, latInput, lngInput, nameInput, dateInput, timeInput, descInput, addrInput);
              hideButtons("block", "none", "none");
            } else {
              addReadOnly(idInput, latInput, lngInput, nameInput, dateInput, timeInput, descInput, addrInput);
          ...
          case 12:
            ...
            dateInput.value = "".concat(event.date.getFullYear(), "-").concat(prefixZero(event.date.getMonth() + 1), "-").concat(prefixZero(event.date.getDate()));
            timeInput.value = "".concat(prefixZero(event.date.getHours()), ":").concat(prefixZero(event.date.getMinutes()), ":00");
            ...
            mapsLink.href = "https://www.google.co.in/maps/@".concat(event.location.coordinates[1], ",").concat(event.location.coordinates[0], ",18z");
            _context.next = 30;
            break;
...
var openModalToAdd = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(coords) {
  ...
  return function openModalToAdd(_x) {
    return _ref2.apply(this, arguments);
  };
}();

exports.openModalToAdd = openModalToAdd;
...
if (editBtn) editBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
  var eventId;
...
if (deleteBtn) deleteBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
  var eventId, res;
      ...
      switch (_context4.prev = _context4.next) {
        ...
        case 7:
          ...
          if (res.status === "sucess") {
            (0, _alert.showAlert)("success", res.message);
            closeModal();
            setTimeout(function () {
              location.reload();
            }, 500);
          } else {
            (0, _alert.showAlert)("error", res.message);
          }
...
if (saveBtn) saveBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
  var eventId, res, _res;
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return fetch("/api/v1/events/".concat(eventId), {
            ...
            body: JSON.stringify({
              ...
              date: new Date("".concat(dateInput.value, "T").concat(timeInput.value)),
        ...
        case 18:
          _context5.prev = 18;
          _context5.next = 21;
          return axios.post("/api/v1/events", {
            name: nameInput.value,
            date: new Date("".concat(dateInput.value, "T").concat(timeInput.value)),
            description: descInput.value,
            location: {
        ...
        case 21:
          ...
          if (_res.data.status === "success") {
            (0, _alert.showAlert)("success", _res.data.message);
            setTimeout(function () {
              location.reload();
            }, 500);
          }
        ...
        case 25:
          ...
          (0, _alert.showAlert)("error", _context5.t1.response.data.message);
  ...
  }, _callee5, null, [[3, 12], [18, 25]]);
})));
},{"./alert":"alert.js","./loader":"loader.js"}],"map.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.moveToView = exports.addToMap = exports.displayMap = void 0;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            mapboxgl.accessToken = "pk.eyJ1IjoiYmxhemVwaG9lbml4IiwiYSI6ImNrbmFkNXJiYjBtcTYzMG55NHNycmlwdHYifQ.atR50NlMkXlMTn52AxgrfA";
            _context2.prev = 1;
            _context2.next = 4;
          ...
          case 10:
            lat = coords ? coords.latitude : 13.1255523;
            lng = coords ? coords.longitude : 79.905998;
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        _context.next = 2;
                        return fetch("/api/v1/users/check-login");
                      ...
                      case 4:
                        ...
                        if (res.loggedIn) {
                          (0, _model.openModalToAdd)(e.lngLat);
                        } else {
...
var addToMap = function addToMap(event) {
  var marker = new mapboxgl.Marker({
    color: "#1976d2"
  }).setLngLat(event.location.coordinates).addTo(map);
  var popup = new mapboxgl.Popup({
    closeOnClick: false,
    anchor: "bottom",
    focusAfterOpen: false,
    offset: 30
  }).setLngLat(event.location.coordinates).setHTML("<p>".concat(event.status, "</p>")).setMaxWidth("400px").addTo(map);
};

exports.addToMap = addToMap;

var moveToView = /*#__PURE__*/function () {
  ...
  return function moveToView(_x2) {
    return _ref3.apply(this, arguments);
  };
}();

exports.moveToView = moveToView;
},{"./model":"model.js"}],"login.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("/api/v1/users/".concat(type === "password" ? "update-password" : "update-profile"), {
              method: "PATCH",
...
},{"./alert":"alert.js"}],"resetPassword.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch("/api/v1/users/forget-password/", {
              method: "POST",
              body: JSON.stringify({
                email: email
              }),
...
},{"./alert":"alert.js"}],"event.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addToEventsBox = exports.getEventsWithDistance = exports.getEvents = void 0;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("/api/v1/events/".concat(query ? "?" + query : ""));
          ...
          case 4:
            ...
            return _context.abrupt("return", res.data.events);
...
var getEventsWithDistance = /*#__PURE__*/function () {
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 13:
            ...
            events.forEach(function (event) {
              event.distance = Math.round(distance(lat, lng, event.location.coordinates[1], event.location.coordinates[0], "K"));
            });
  ...
  return function getEventsWithDistance(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.getEventsWithDistance = getEventsWithDistance;

var addToEventsBox = function addToEventsBox(event, eventsBox) {
  event.date = new Date(event.date);
  var html = "\n        <li class=\"event\" data-id=\"".concat(event.id, "\">\n            <h2 class=\"event__title\">").concat(event.name, " <span>").concat(event.distance, " km </span></h2>\n            <div class=\"event__details\">\n                <span class=\"event__icon\">\uD83D\uDDD3\uFE0F</span>\n                <span class=\"event__value\"> &nbsp;&nbsp;").concat(event.date.toLocaleString("en-IN", {
    day: "numeric",
    month: "long",
    year: "numeric"
  }), "</span>\n            </div>\n            <div class=\"event__details\">\n              <span class=\"event__icon\">\u23F0</span>\n              <span class=\"event__value\"> &nbsp;&nbsp;").concat(event.date.getHours() == 12 || event.date.getHours() == 0 ? 12 : event.date.getHours() % 12, " : ").concat((event.date.getMinutes() + "").padStart(2, "0"), " &nbsp;").concat(event.date.getHours() < 12 ? "AM" : "PM", "</span>\n          </div>\n            <div class=\"overlay\">\n                <img class=\"overlay__image overlay__image--open\" src=\"./resources/open.svg\" alt=\"\">\n                <img class=\"overlay__image overlay__image--map\" src=\"./resources/map.svg\" alt=\"\">\n            </div>\n        </li>\n                ");
  eventsBox.insertAdjacentHTML("beforeend", html);
};

exports.addToEventsBox = addToEventsBox;
...
var getDateString = function getDateString(date) {
  return "<span>".concat(months[date.getMonth()], " ").concat(date.getDate(), ", ").concat(date.getFullYear(), "</span>\n    <span>").concat(date.getHours() == 12 ? 12 : date.getHours() % 12, " : ").concat((date.getMinutes() + "").padStart(2, "0"), " ").concat(date.getHours() < 12 ? "AM" : "PM", "</span>");
};

var setTimer = function setTimer(timer) {
  var date = new Date();
...
var passwordForgotForm = document.querySelector(".form--password-forgot");
var logoutBtn = document.querySelector(".side-nav--logout");
var eventsNameList = document.querySelector("#events-name");
var eventsBox = document.querySelector(".events");
var searchInput = document.querySelector(".search-bar");
var searchForm = document.querySelector(".search-div");
var sortInput = document.querySelector(".select--sort");
var filterInput = document.querySelector(".select--filter");
var timeEl = document.querySelector(".nav__el--time");
...
if (timeEl) (0, _timer.setTimer)(timeEl);
...
if (dataForm) dataForm.addEventListener("submit", /*#__PURE__*/function () {
...
if (passwordResetForm) passwordResetForm.addEventListener("submit", /*#__PURE__*/function () {
...
if (passwordForgotForm) passwordForgotForm.addEventListener("submit", /*#__PURE__*/function () {
...
if (logoutBtn) logoutBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7() {
...
if (eventsBox) {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            eventsBox.innerHTML = "";
            _context8.next = 4;
            return (0, _event.getEventsWithDistance)();

          case 4:
            events = _context8.sent;
            events.forEach(function (event) {
              eventsNameList.insertAdjacentHTML("beforeend", "<option value=\"".concat(event.name, "\">").concat(event.name, "</option>"));
              (0, _event.addToEventsBox)(event, eventsBox);
              (0, _map.addToMap)(event);
            });
            (0, _loader.hideLoader)();
  ...
  eventsBox.addEventListener("click", /*#__PURE__*/function () {
    var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(e) {
      var eventDiv, eventId, _eventDiv, _eventId;
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              eventDiv = e.target.closest(".event");
            ...
            case 4:
              eventId = eventDiv.dataset.id;
              (0, _loader.showLoader)();
              _context9.next = 8;
              return (0, _model.openModal)(eventId, false);
            ...
            case 9:
              ...
              _eventDiv = e.target.closest(".event");
            ...
            case 13:
              _eventId = _eventDiv.dataset.id;
              _context9.next = 16;
              return (0, _map.moveToView)(_eventId);
...
if (searchForm) searchForm.addEventListener("submit", /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            filterInput.value = "";
            _context10.next = 10;
            return (0, _event.getEventsWithDistance)("".concat(name ? "name=" + name : ""));
...
if (sortInput) sortInput.addEventListener("input", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11() {
  var events, query;
  return regeneratorRuntime.wrap(function _callee11$(_context11) {
    while (1) {
      switch (_context11.prev = _context11.next) {
        ...
        case 9:
          if (!sortInput.value.endsWith("date")) {
            _context11.next = 16;
            break;
          }

          query = sortInput.value ? "sort=".concat(sortInput.value) : "";
          _context11.next = 13;
          return (0, _event.getEventsWithDistance)(query);
...
var isToday = function isToday(date) {
  return new Date().getFullYear() === new Date(date).getFullYear() && new Date().getMonth() === new Date(date).getMonth() && new Date().getDate() === new Date(date).getDate();
};

if (filterInput) filterInput.addEventListener("input", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12() {
  var events;
    ...
    while (1) {
      switch (_context12.prev = _context12.next) {
        ...
        case 5:
          ...
          if (filterInput.value === "") {} else if (filterInput.value == "today") {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "38253" + '/');
